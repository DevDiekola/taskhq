...
export const STATUS_CLASS_NAMES: Readonly<
  Record<TaskStatus, TaskGroupClassNames>
> = {
  not_started: {
...
export const PRIORITY_CLASS_NAMES: Readonly<
  Record<TaskPriority, TaskGroupClassNames>
> = {
  none: {
    background: "bg-gray-100",
    foreground: "text-gray-800",
...
export const UNDO_TASK_ACTION: PayloadAction<string> = {
  type: "UNDO",
  payload: TASK_SLICE_NAME,
};
export const REDO_TASK_ACTION: PayloadAction<string> = {
  type: "REDO",
  payload: TASK_SLICE_NAME,
};
